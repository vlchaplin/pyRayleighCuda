...
SWIGINTERN PyObject *_wrap_RSgpuCalcField(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  double arg1 ;
...
static PyMethodDef SwigMethods[] = {
	 ...
	 { (char *)"RSgpuCalcField", _wrap_RSgpuCalcField, METH_VARARGS, (char *)"Calculate the ndgrid style {xp X yp X zp} pressure field"},
	 { NULL, NULL, 0, NULL }
};
