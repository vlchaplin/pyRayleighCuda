	...
	)
{
	...
	Pennes_2ndOrder_GPU( &(T->data[L]), Tdot_source->data, kt0->data, rho_Cp->data, Dtxyz, Tblood, perfusionrate, nt, nx, ny, nz, bcMode);
}
	...
	)
{
	...
	Pennes_2ndOrder_GPU_f(T->data + L, Tdot_source->data, kt0->data, rho_Cp->data, Dtxyz, Tblood, perfusionrate, nt, nx, ny, nz, bcMode);
}
