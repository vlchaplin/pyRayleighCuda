...
for n=1:nPairs
    ...
    outpath='C:\Users\Vandiver\Data\sonalleve\BatchAnalysis\curves\';
    
    
    outfilename1=strrep( get(pl1,'DisplayName'),' ', '_');
    outfilename2=strrep( get(pl2,'DisplayName'),' ', '_');
