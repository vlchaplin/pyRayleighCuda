...
def pbheSolve_f(useFreeflow: 'int', dt: 'float', dx: 'float', dy: 'float', dz: 'float', T: 'mesh4d_f', Tdot_source: 'mesh4d_f', kt0: 'mesh3d_f', rho_Cp: 'mesh3d_f', Tblood: 'float', perfusionrate: 'float', ta_i: 'long'=0, tb_i: 'long'=-1) -> "void":
    return _PBHEswig.pbheSolve_f(useFreeflow, dt, dx, dy, dz, T, Tdot_source, kt0, rho_Cp, Tblood, perfusionrate, ta_i, tb_i)
pbheSolve_f = _PBHEswig.pbheSolve_f

def pbheSolve(useFreeflow: 'int', dt: 'double', dx: 'double', dy: 'double', dz: 'double', T: 'mesh4d', Tdot_source: 'mesh4d', kt0: 'mesh3d', rho_Cp: 'mesh3d', Tblood: 'double', perfusionrate: 'double', ta_i: 'long'=0, tb_i: 'long'=-1) -> "void":
    return _PBHEswig.pbheSolve(useFreeflow, dt, dx, dy, dz, T, Tdot_source, kt0, rho_Cp, Tblood, perfusionrate, ta_i, tb_i)
pbheSolve = _PBHEswig.pbheSolve
class mesh1d_f(object):
    ...
    def setndims(self, num: 'long') -> "void":
        return _PBHEswig.mesh1d_f_setndims(self, num)

    def setdims(self, dims: 'long *') -> "void":
...
class mesh3d_f(mesh1d_f):
    ...
    def index(self, *args) -> "long":
        return _PBHEswig.mesh3d_f_index(self, *args)

    def val(self, *args) -> "float &":
        return _PBHEswig.mesh3d_f_val(self, *args)

    def __call__(self, i0: 'long', i1: 'long', i2: 'long') -> "float &":
        return _PBHEswig.mesh3d_f___call__(self, i0, i1, i2)

    def getval(self, i0: 'long', i1: 'long', i2: 'long') -> "float":
        return _PBHEswig.mesh3d_f_getval(self, i0, i1, i2)

    def setval(self, val: 'float', i0: 'long', i1: 'long', i2: 'long') -> "void":
...
class mesh4d_f(mesh1d_f):
    ...
    def __call__(self, i0: 'long', i1: 'long', i2: 'long', i3: 'long') -> "float &":
        return _PBHEswig.mesh4d_f___call__(self, i0, i1, i2, i3)

    def getval(self, i0: 'long', i1: 'long', i2: 'long', i3: 'long') -> "float":
        return _PBHEswig.mesh4d_f_getval(self, i0, i1, i2, i3)

    def setval(self, val: 'float', i0: 'long', i1: 'long', i2: 'long', i3: 'long') -> "void":
        return _PBHEswig.mesh4d_f_setval(self, val, i0, i1, i2, i3)

    def getpage(self, i0: 'long') -> "MeshFunction3D< float > *":
...
class mesh3d(mesh1d):
    ...
    def val(self, *args) -> "double &":
        return _PBHEswig.mesh3d_val(self, *args)

    def __call__(self, i0: 'long', i1: 'long', i2: 'long') -> "double &":
        return _PBHEswig.mesh3d___call__(self, i0, i1, i2)

    def getval(self, i0: 'long', i1: 'long', i2: 'long') -> "double":
        return _PBHEswig.mesh3d_getval(self, i0, i1, i2)

    def setval(self, val: 'double', i0: 'long', i1: 'long', i2: 'long') -> "void":
...
class mesh4d(mesh1d):
    ...
    def __call__(self, i0: 'long', i1: 'long', i2: 'long', i3: 'long') -> "double &":
        return _PBHEswig.mesh4d___call__(self, i0, i1, i2, i3)

    def getval(self, i0: 'long', i1: 'long', i2: 'long', i3: 'long') -> "double":
        return _PBHEswig.mesh4d_getval(self, i0, i1, i2, i3)

    def setval(self, val: 'double', i0: 'long', i1: 'long', i2: 'long', i3: 'long') -> "void":
        return _PBHEswig.mesh4d_setval(self, val, i0, i1, i2, i3)

    def getpage(self, i0: 'long') -> "MeshFunction3D< double > *":
